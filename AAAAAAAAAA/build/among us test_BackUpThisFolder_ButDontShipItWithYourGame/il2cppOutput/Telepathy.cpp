...
IL_00ab:
		{
			...
			int32_t L_46 = V_0;
			NullCheck(L_44);
			VirtActionInvoker3< ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726*, int32_t, int32_t >::Invoke(29 /* System.Void System.IO.Stream::Write(System.Byte[],System.Int32,System.Int32) */, L_44, L_45, 0, L_46);
			// return true;
			V_4 = (bool)1;
			goto IL_00da;
		}
...
FINALLY_00c4:
	{ // begin finally (depth: 1)
		...
		NullCheck(L_38);
		VirtActionInvoker0::Invoke(16 /* System.Void System.IO.Stream::Close() */, L_38);
		// client.Close();
...
FINALLY_006f:
	{ // begin finally (depth: 1)
		...
		NullCheck(L_22);
		VirtActionInvoker0::Invoke(16 /* System.Void System.IO.Stream::Close() */, L_22);
		// client.Close();
